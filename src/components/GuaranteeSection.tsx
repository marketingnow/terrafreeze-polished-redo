...
const GuaranteeSection = () => {
  return (
    <section className="section-supporting bg-background" id="guarantee">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <a href="#buy" className="inline-flex items-center justify-center px-6 py-3.5 bg-white text-accent font-semibold hover:bg-white/90 transition-all duration-300 hover:shadow-elevated group" style={{ borderRadius: "4px" }}>
                Try It Risk-Free
