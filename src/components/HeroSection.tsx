      ...
      <div className="relative content-container py-8 lg:py-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-10 items-center">
          ...
          <div className="order-2 lg:order-1 stagger-children">
            ...
            {/* Subheadline */}
            <p className="font-display text-muted-foreground font-normal leading-relaxed mb-4 max-w-lg" style={{ fontSize: "20px" }}>
            ...
            <ul className="space-y-2.5 mb-5">
              {[
                ...
                <li key={i} className="flex items-start gap-2.5">
                  ...
                  <span className="font-display text-muted-foreground font-normal" style={{ fontSize: "18px" }}>{point}</span>
                </li>
              ))}
            </ul>
