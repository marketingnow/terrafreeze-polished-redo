...
const faqs = [{
  ...
  answer: "Yes! TERRAFREEZE™ is specifically formulated to target joint pain, including knee, shoulder, hip, and elbow discomfort. The cooling-then-soothing action penetrates deep to provide relief where you need it most."
}, {
  question: "Is it just another menthol cream?",
  answer: "TERRAFREEZE™ goes beyond basic menthol creams. Our advanced formula combines cooling relief with soothing botanicals and active ingredients that work together to provide longer-lasting comfort without the harsh medicinal smell."
}, {
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="glass-card rounded-xl p-5 lg:p-6">
            <Accordion type="single" collapsible className="w-full">
              {faqs.map((faq, index) => <AccordionItem key={index} value={`item-${index}`} className="border-b border-border/40 last:border-0">
