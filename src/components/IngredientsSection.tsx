...
const IngredientsSection = () => {
  return <section className="section-supporting bg-secondary/30">
      <div className="content-container">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {ingredients.map((ingredient, index) => <div key={index} className="glass-card rounded-xl p-5 group hover:shadow-elevated transition-all duration-300">
